...
<!-- Session is already provided in jsp, no need to import -->
<!-- fetching session data i.e currentUser , then typeCasting the data in User type and storing in User object -->
<%
...
<body>
	...
	<main>
		...
		<div class="row mt-4">
			...
			<!-- second column, Post will be shown here as per the catID or misleneous -->	
		<div class="col-md-8" >
...
<!-- Start of main body -->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Add new Post to
						Blog</h5>
				...
				<div class="modal-body">
					...
					<form id="add-post-form" action="addPostServlet" method="post">
						...
						<div class="form-group">
							<input type="text" name="pTitle" class="form-control" id="title"
								name="title" placeholder="Enter the Title">
						</div>
						<div class="form-group">
							<textarea class="form-control" name="pContent"
								style="height: 200px;" placeholder="Enter Content"></textarea>
						</div>
						<div class="form-group">
							<textarea class="form-control" name="pCode"
								style="height: 200px;" placeholder="Enter Code(if any)"></textarea>
						</div>
					
						
					 <div class="form-group">
								<label for="image">Upload image</label> <input type="file"
									name="pic" class="form-control-file" id="file">	
	...
	<!-- Now writing add-post-form code -->
	<script type="text/javascript">
		$(document).ready(function(e) {

			$("#add-post-form").on("submit", function(event) {
				//this code will execute when add-post-form is submited
				//Asynchronous call
				...
				$.ajax({
					...
					success : function(data, textStatus, jqXHR) {
						...
						console.log(data);
						if(data.trim()==="posted"){
							swal("Good job!","Succesfully Posted","success");
						}
						else 
						{
							swal("Error!!","Something went wrong! Try again...Data not posted","error");
						}
					},
